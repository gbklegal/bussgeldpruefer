<template>
    <div class="container">
        ...
        <ol class="ml-5 list-decimal">
            <li>
                <h2 class="text-lg font-bold">Name und Kontaktdaten des für die Verarbeitung Verantwortlichen</h2>
                <div class="mb-4">
                    <p>Diese Datenschutzhinweise gelten für die Datenverarbeitung durch:</p>
                    <p>Verantwortlicher:</p>
                    <p>GDF GmbH (im Folgenden ggf. auch: „GDF“ oder „wir“),<br>vertreten durch den Geschäftsführer Herrn Tobias Gußmann,<br>Kaiserstraße 23, 90403 Nürnberg, Deutschland<br>
                    Sitz: Nürnberg<br>Handelsregister: Amtsgericht Nürnberg HRB 33156<br>E-Mail: <a href="mailto:dialog@bussgeldpruefer.com">dialog@bussgeldpruefer.com</a><br>Telefon: <a href="tel:0911893103444">0911/893103-444</a></p>
                </div>
            </li>
            <li>
                <h2 class="text-lg font-bold">Erhebung und Speicherung personenbezogener Daten sowie Art und Zweck von deren Verwendung</h2>
                <ol>
                ...
                <div class="mb-4">
                    <p class="mb-2">Beim Aufrufen unserer Website www.steuermachen.de werden durch den auf Ihrem Endgerät zum Einsatz kommenden Browser automatisch Informationen an den Server unserer Website gesendet. Diese Informationen werden temporär in einem sog. Logfile gespeichert. Folgende Informationen werden dabei ohne Ihr Zutun erfasst und bis zur automatisierten Löschung gespeichert:</p>
                    <p class="ml-4 mb-4">IP-Adresse des anfragenden Rechners,<br>Datum und Uhrzeit des Zugriffs,<br>Name und URL der abgerufenen Datei,<br>Website, von der aus der Zugriff erfolgt (Referrer-URL),<br>verwendeter Browser und ggf. das Betriebssystem Ihres Rechners sowie der Name Ihres Access-Providers.</p>
                    <p class="mb-2">Die genannten Daten werden durch uns zu folgenden Zwecken verarbeitet:</p>
                    <p>Gewährleistung eines reibungslosen Verbindungsaufbaus der Website,
                        <br>
            ...
            <br>
            <li>
                <h2 class="text-lg font-bold">Weitergabe von Daten</h2>
                
                <div class="mb-4">
                    <p class="mb-2">Eine Übermittlung Ihrer persönlichen Daten an Dritte zu anderen als den im Folgenden aufgeführten Zwecken findet nicht statt.</p>
                    <p class="mb-2">Wir geben Ihre persönlichen Daten nur an Dritte weiter, wenn:</p>
                    <p class="ml-4 mb-2">Sie Ihre nach Art. 6 Abs. 1 S. 1 lit. a DSGVO ausdrückliche Einwilligung dazu erteilt haben,
                        <br>
            ...
            <br>
            <li>
                <h2 class="text-lg font-bold">Widerspruchsrecht</h2> 
                <div>
                    <p>Sofern Ihre personenbezogenen Daten auf Grundlage von berechtigten Interessen gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden, haben Sie das Recht, gemäß Art. 21 DSGVO Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten einzulegen, soweit dafür Gründe vorliegen, die sich aus Ihrer besonderen Situation ergeben oder sich der Widerspruch gegen Direktwerbung richtet. Im letzteren Fall haben Sie ein generelles Widerspruchsrecht, das ohne Angabe einer besonderen Situation von uns umgesetzt wird.</p>
                    <br>
                    <p>Möchten Sie von Ihrem Widerrufs- oder Widerspruchsrecht Gebrauch machen, genügt eine E-Mail an dialog@steuermachen.de.</p>
                    <br>
                </div>
            </li>
            <br>
            <li>
                <h2 class="text-lg font-bold">Datensicherheit</h2> 
                <div>
            ...
            <br>
            <li>
                <h2 class="text-lg font-bold">Aktualität und Änderung dieser Datenschutzerklärung</h2> 
                <div>
                    <p>Diese Datenschutzerklärung ist aktuell gültig und hat den Stand August 2021. Durch die Weiterentwicklung unserer Website und Angebote darüber oder aufgrund geänderter gesetzlicher beziehungsweise behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern. Die jeweils aktuelle Datenschutzerklärung kann jederzeit auf der Website unter https://bussgeldpruefer.com/datenschutz/ von Ihnen abgerufen und ausgedruckt werden.</p>  
                </div>
            </li>
            <br>
        </ol>
