    ...
    <section class="">
      <div class="container flex flex-col md:flex-row justify-center md:justify-between">
        <div class="md:max-w-1/2">
          <h2 class="font-medium mb-5 text-3xl md:text-4xl">Mit dem BussgeldPrüfer fährst du richtig:</h2>
    ...
    <section class="success lg:flex w-full overflow-hidden">
        <div class="first-half my-20 lg:max-w-1/2 lg:grid mb-20 lg:mb-0">
            ...
            <div class="container lg:pr-0 lg:container-half-left">
                ...
                <p class="">Mit dem BussgeldPrüfer erhöhst du deine Chance erfolgreich gegen deinen Bußgeldbescheid vorzugehen. Klicke jetzt auf “Prüfung Bußgeldbescheid” um deinen Bußgeldbescheid anzufechten.</p>
            </div>
        </div>
