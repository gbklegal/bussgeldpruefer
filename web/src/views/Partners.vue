    ...
    <div class="container">
        ...
        <div class="flex flex-col md:flex-row items-center mb-10">
            <div class="border-2 rounded-full grid place-items-center text-center border-primary h-44 w-44 mb-6 md:mb-0 md:mr-4">
                <h2 class="mb-0 text-xl text-secondary">Autohändler, Werkstätten, Versicherungen</h2>
            </div>
            <div class="max-w-md">
        ...
        <div class="flex flex-col md:flex-row items-center mb-10">
            <div class="border-2 rounded-full grid place-items-center text-center border-primary h-44 w-44 mb-6 md:mb-0 md:mr-4">
                <h2 class="mb-0 text-xl text-secondary">Partneranwalt</h2>
            </div>
            <div class="max-w-md">
                <p class="text-secondary mb-4">Du bist als zugelassener Anwalt tätig? Dann werde Teil des <span class="text-primary">BussgeldPrüfer</span> Teams</p>
            </div>
        </div>
